...
import { Home, Clock, CreditCard, Star, Settings, Menu, X, MapPin, Bell, BarChart2, MessageSquare, UserCheck, Shield } from "lucide-react";
          ...
          <div className="hidden md:flex justify-end items-center mb-6 p-4 rounded-lg bg-white/60 backdrop-blur-sm shadow-sm">
            <div className="flex items-center">
              <div className="mr-2 text-right">
                <p className="font-medium text-sm text-gray-800">John Driver</p>
                <p className="text-xs text-gray-500">john.driver@example.com</p>
              </div>
